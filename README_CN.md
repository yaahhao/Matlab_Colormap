...
![ColorKit 封面图](Figures/ColorKit_cover_hd.png)

作者：zhaoyh  
Email：zhao2025@mail.sustech.edu.cn

ColorKit 是一个面向 MATLAB 科研绘图的紧凑型 colormap / palette 工具箱。它包含约 100 套内置命名配色，并支持图片点击取色、截图 colorbar 恢复、图片主题色提取、色卡浏览、用户预设，以及交互式 `ColormapDesigner` GUI。
...
Demo 图由 `Demo_ColorKitFull.m` 生成，并存放在 `Figures/` 文件夹。图片工作流使用的源图在对应位置标注来源。
...
源图改编自 Denolle et al. (2014), *Science*, 343(6169), 399-403, https://doi.org/10.1126/science.1245678。
...
源图改编自 Gräff et al. (2025), *Nature*, 644(8076), 404-412, https://doi.org/10.1038/s41586-025-09347-7。
